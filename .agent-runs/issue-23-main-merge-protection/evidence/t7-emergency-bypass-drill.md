...
- **事后补验**（S4 复审要求：恢复证据 ≠ 补验证据）：被绕过 PR #31 的变更在操作完成后约 2 小时
  由成功 run 31774866515（head `64ed09fc`，head 祖先链包含被绕过合并）完成等价验收，
  在 24 小时期限内——详见 [`t7-post-verification.md`](t7-post-verification.md)。
