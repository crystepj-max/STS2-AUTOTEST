...
- 阶段：T1 取证已归档；T2/T3(脚本)/T4/T5 开发完成；S4 返工完成；
  ...
  T3 探针已部署、连续采集中（维护标记链路 14:11 完整，2026-08-21 14:11 满 7 天，**满 7 天前不视为完成**）；
...
2. **T3 部署：✅ 已部署，⏳ 采集中（未完成）** → evidence/deployment-t3-20260814.md
   ...
   `~/.sts2-runner-probe/`；**连续采集满 7 天（2026-08-21 14:11 UTC）才算 T3 完成**）。
...
4. **T7 收口：⏳ 待 8/21**——定时任务已设（**2026-08-21 14:37，本地时区，
   晚于 14:11 UTC 满 7 天**，持久化 CronCreate），检视 T2/T3/T6/T7 结果后
