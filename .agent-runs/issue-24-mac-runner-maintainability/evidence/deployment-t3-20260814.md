...
## 采集周期（2026-08-14 修正：从维护标记链路完整后重新计时）

- 首采：2026-08-14 11:54 UTC（launchd 部署）。
- **修正**：维护操作归因链路（runner-ctl 写 ops.jsonl + 探针消费）在
  2026-08-14 14:11 UTC 演练后完整生效；**11:54–14:11 的采样 op 字段为空**，
  不构成完整四类可归因数据（bot 审查 P1 意见 3784471382）。
- **七天采集期重新计时：自 2026-08-14 14:11 UTC 起，2026-08-21 14:11 UTC 满 7 天**。
